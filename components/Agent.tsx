...
// ✅ FIX 1: Define AgentProps interface (was missing entirely)
...
// ✅ FIX 2: Define Message type (was missing entirely)
interface Message {
  type: string;
...
const Agent = ({
  ...
  // ✅ FIX 3: Added missing `questions` to dependency array
  ...
  return (
    <>
      ...
      <div className="w-full flex justify-center">
        {/* ✅ FIX 4: Compare callStatus using enum values, not raw strings */}
